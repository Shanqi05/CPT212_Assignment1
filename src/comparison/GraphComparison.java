...
public class GraphComparison {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("╔════════════════════════════════════════════════════════════════╗");
        System.out.println("║   Small Numbers Comparison (1 to 100 digits)                   ║");
        System.out.println("╚════════════════════════════════════════════════════════════════╝");
        System.out.println();
        ...
        System.out.println("✓ CSV file saved as 'comparison_results.csv'");
    }
    ...
    public static void drawComparisonGraph(int[] n, long[] simple, long[] karatsuba, String filename) throws Exception {
        ...
        g.drawString("Algorithm Comparison: Primitive Operations Analysis", 120, 40);
        ...
        for (int i = 0; i < n.length; i++) {
            ...
            g.drawString(String.valueOf(n[i]), x - 10, HEIGHT - PADDING + 25);
        }
